...
namespace ExampleGame
{
    public class Image
    {
        ...
        void SetEffect<T>(ref T effect)
        {
            ...
            effectList.Add(effect.GetType().ToString().Replace("ExampleGame.", ""), (effect as ImageEffect));
        }
        ...
        public void LoadContent() 
        {
            ...
            Texture = renderTarget; // set texture to one image containing texture and text
